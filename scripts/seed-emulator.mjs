/**
 * Seed the Firebase emulator with sample Moving Day data.
 * Uses the Admin SDK so security rules are bypassed entirely.
 *
...
initializeApp({ projectId: 'demo-movingday' });
...
const items = [
  ...
  },
  {
    id: 'item-2',
    name: 'Sony 32" TV',
    description: 'Works perfectly, includes remote. HDMI × 3, USB × 2. Selling because I upgraded. Bought 2 years ago.',
    condition: 'good',
    status: 'claimed',
  ...
  },
  {
    ...
    description: 'Solid wood, mid-century style, some wear on top. Legs are sturdy. 90 × 50cm.',
    condition: 'fair',
    status: 'available',
    category: 'Furniture',
  ...
  },
  {
    ...
    claimedBy: { uid: 'user-demo-2', name: 'João M.', email: 'joao@example.com' },
